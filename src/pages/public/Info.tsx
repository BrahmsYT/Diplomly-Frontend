...
export function About() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-14">
      <h1 className="text-3xl font-bold tracking-tight text-slate-900">Diplomly haqqında</h1>
      ...
      <h2 className="mt-10 text-xl font-semibold text-slate-900">Həll etdiyimiz problem</h2>
      ...
      <h2 className="mt-10 text-xl font-semibold text-slate-900">Necə işləyir</h2>
...
export function ForOrganizations() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      <h1 className="text-3xl font-bold tracking-tight text-slate-900">Təşkilatlar üçün</h1>
